Problem description
    title = "SOFS 12 case 1 - sofs-10 +500 kg configuration current=CF wave-height=SWH wind=WIND TM sampler"
    type = surface
...
Layout
    ...
    segment = {        length = 0.28     material = term_e        nodes = (3, 1)    }
    connector = pivot
    segment = {        length = 18       material = balls_1/2in        nodes = (41, 1)    }
    connector = pivot
...
Materials
    ...
    TM
        type=linear        diam=0.2           wet=50.0        mass=12        length=1.0
        Cdn=1.0        Cdt=0.1        EA=1e+06        EI=82900        GJ=10000
        SWL=0        yield=0
        comment="Ti Bar TM sampler"
    SOFScageHD
        type=linear        diam=0.2           wet=225.0        mass=30        length=1.0
